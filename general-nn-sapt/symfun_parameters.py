...
class NNforce_field(object):
    ...
    def initialize_GA_opt(self):
        ...
        # add list of symmetry function tuples
        sulfurNN.radial_symmetry_functions.append((6.3775510, 7.50))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 7.22))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 6.94))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 6.66))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 6.38))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 6.10))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 5.82))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 5.54))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 5.26))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 4.98))
        sulfurNN.radial_symmetry_functions.append((6.3775510, 4.70))
