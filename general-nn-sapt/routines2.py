...
class DataSet:
    ...
    def __init__(self, path):
        ...
        Includes suitable tensors for usual SAPT neural network 
        training tasks. Additions should be made with great consideration
        about the data source, since there is minimal handling for erroneous
        objects.
